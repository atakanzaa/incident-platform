...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Alert> consumerFactory() {
        ...
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "latest"); // Only new messages for dashboard
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, true);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JsonDeserializer.TYPE_MAPPINGS, "alert:com.incident.dashboard_service.model.Alert");
